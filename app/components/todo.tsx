...
export default function Todo() {
    ...
    return (
        <Paper className="flex flex-col flex-1 items-center justify-start font-sans    md:w-1/2 break-all p-8 m-2">
            <Typography variant="h1">Todo</Typography>
            <List className="md:overflow-y-auto w-1/1 scrollbar-thumb-gray-500">
                <ListItem>
                    <TextField
                        value={newTodo}
